         ...
         <div class="col-lg-4 col-md-6">
            <div class="single-footer-widget m_news_widgets">
               ...
               <div class="col-lg-4 col-md-4 footer-social icon mx-auto">
                  <a href="https://twitter.com/penseepis"><i class="fa fa-twitter"></i></a>
                  <a href="https://www.instagram.com/penseepis/"><i class="fa fa-instagram"></i></a>
                  <a href="https://www.youtube.com/channel/UCgCH04Vjy22hnfTZBTMDccQ"><i class="fa fa-youtube-play"></i></a>
               </div>
            </div>
         </div>
      </div>
